...
### Methods
I train multiple $\text{CATE}$ estimators, including *S-Learners*,*T-Learners*, *X-Learners*, *DR-Learners*, *R-Learners*,  *Double Machine Learning* models, *Causal Forests*, and train (and compare) targeting policies based on the estimated heterogeneous treatment effects $\hat{\tau}(x)$. For policy learning I rely on two methods.
...
For policy evaluation I rely on the **Inverse Propensity Score** method: 
